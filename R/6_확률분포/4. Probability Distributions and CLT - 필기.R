...
y <- dbinom(0:70, size=70, prob=0.5)
k<-rbinom(1000, size=70, prob=0.5)
hist(k,  prob = T, breaks = 30, main = "이항분포의 표본 분포",
     xlab = "확률변수", ylab = "Probability")
lines(density(k), col="blue", lty = 1, lwd = 2)
lines(0:70, y, pch = 22, col = "red", lty = 1, lwd = 2)
legend('topright', c("난수의 분포", "이론적분포"), 
       col = c("blue", "red"), lty = c(1,1))
...
#이항분포
y <- dbinom(0:70, size=70, prob=0.5)
k<-rbinom(18000, size=70, prob=0.5)
hist(k,  prob = T, breaks = 30, main = "이항분포의 표본 분포",
     xlab = "확률변수", ylab = "Probability")
lines(density(k), col="blue", lty = 1, lwd = 2)
lines(0:70, y, pch = 22, col = "red", lty = 1, lwd = 2)
